...
function OccupancyAnalytics({ students }: OccupancyAnalyticsProps) {
  ...
  // Seat utilization by section (simulated - divide 120 seats into sections)
  const sectionUtilization = [
    { section: 'Section A (1-30)', occupied: Math.min(30, Math.floor(occupiedSeats * 0.3)), total: 30 },
    { section: 'Section B (31-60)', occupied: Math.min(30, Math.floor(occupiedSeats * 0.28)), total: 30 },
    { section: 'Section C (61-90)', occupied: Math.min(30, Math.floor(occupiedSeats * 0.25)), total: 30 },
    { section: 'Section D (91-120)', occupied: Math.min(30, Math.floor(occupiedSeats * 0.17)), total: 30 },
  ];
