  ...
  try {
    ...
    if (req.method === 'GET') {
      ...
      const mapStudent = (student) => ({
        ...
        customMonthlyAmount: student.custom_monthly_amount || student.customMonthlyAmount || undefined,
    ...
    if (req.method === 'POST') {
      ...
      const studentData = {
        ...
        custom_monthly_amount: req.body.customMonthlyAmount || null,
      ...
      const responseStudent = {
        ...
        customMonthlyAmount: newStudent.custom_monthly_amount || undefined,
    ...
    if (req.method === 'PUT') {
      ...
      const updateDoc = {
        ...
        custom_monthly_amount: updateData.customMonthlyAmount !== undefined ? (updateData.customMonthlyAmount || null) : undefined,
      ...
      const responseStudent = {
        ...
        customMonthlyAmount: updatedStudent.custom_monthly_amount || undefined,
